...
function renderHeatmap(props = {}) {
  const heatmap = {
    ...
    weeks: [
      [
        { day: "2026-04-26", conversation_count: 0, total_tokens: 0, level: 0 },
        { day: "2026-04-27", conversation_count: 3, total_tokens: 120, level: 1 },
        { day: "2026-04-28", conversation_count: 6, total_tokens: 240, level: 2 },
        { day: "2026-04-29", conversation_count: 12, total_tokens: 480, level: 3 },
        { day: "2026-04-30", conversation_count: 24, total_tokens: 960, level: 4 },
        { day: "2026-05-01", conversation_count: 4, total_tokens: 180, level: 1 },
        { day: "2026-05-02", conversation_count: 9, total_tokens: 360, level: 2 },
      ],
    ],
  };
